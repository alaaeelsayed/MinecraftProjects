...
public class TargetBlockUtils {
     ...
     */
    public TargetBlockUtils(Player player)
    {
     ...
     */
    public TargetBlockUtils(Location loc)
    {
     ...
     */
    public TargetBlockUtils(Player player, int maxDistance, double checkDistance)
    {
     ...
     * @param checkDistance How often to check for blocks, the smaller the more precise
     */
    public TargetBlockUtils(Location loc, int maxDistance, double checkDistance) {
     ...
     */
    public TargetBlockUtils (Player player, int maxDistance, double checkDistance, int[] blocksToIgnore)
    {
     ...
     */
    public TargetBlockUtils (Location loc, int maxDistance, double checkDistance, int[] blocksToIgnore)
    {
     ...
     */
    public TargetBlockUtils (Player player, int maxDistance, double checkDistance, ArrayList<String> blocksToIgnore)
    {
     ...
     * @param blocksToIgnore String ArrayList of what block ids to ignore while checking for viable targets
     */
    public TargetBlockUtils (Location loc, int maxDistance, double checkDistance, ArrayList<String> blocksToIgnore)
    {
        int[] bti = this.convertStringArraytoIntArray(blocksToIgnore);
    ...
    public static Block getTarget(Player player) {
    	return (new TargetBlockUtils(player)).getTargetBlock();
    }
    
    public static Block getTarget(Player player, int maxdistance) {
    	return (new TargetBlockUtils(player, maxdistance, DEFAULT_CHECKDISTANCE)).getTargetBlock();
    }
}