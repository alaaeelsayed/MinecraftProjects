package me.headshot.headenchants.events;
...
public final class ArmorEquipEvent extends PlayerEvent implements Cancellable{
	 ...
	 */
	public ArmorEquipEvent(final Player player, final EquipMethod equipType, final ItemType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
		super(player);
