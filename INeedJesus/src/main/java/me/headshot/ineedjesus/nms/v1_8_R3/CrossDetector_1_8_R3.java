...
public class CrossDetector_1_8_R3 implements CrossDetector {
    @Override
    ...
    public void setCross(Block block) {
        ...
        for (int k = 0; k < getDetectorCrossLong(block.getType().name().toLowerCase()).c(); ++k) {
            for (int l = 0; l < this.getDetectorCrossLong(block.getType().name().toLowerCase()).b(); ++l) {
                BlockPosition pos = getDetectedBlocks(block).a(k, l, 0).getPosition();
        ...
        Cross cross = new Cross_1_8_R3(blockLocations, armorStand);
        CrossUtil.addCrosses(cross);
    }
    ...
    private ShapeDetector getDetectorCrossLong(String mat) {
        return ShapeDetectorBuilder.a().a(new String[]{"~#~", "###", "~#~", "~#~"}).a('#', ShapeDetectorBlock.a(BlockStatePredicate.a(net.minecraft.server.v1_8_R3.Block.getByName(mat)))).a('~', ShapeDetectorBlock.a(BlockStatePredicate.a(Blocks.AIR))).b();
    }
}
